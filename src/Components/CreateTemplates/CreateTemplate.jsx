...
import { saveTemplate } from "../../Server/trainingService"
import BackButton from "../BackButton/BackButton"

const generateId = () => Math.random().toString(36).substr(2, 9)

export default function CreateTemplate({ setShowPage }) {
  ...
  const savedTemplate = () => {
    ...
    setShowPage('template')
  }

  const validSetsCount = (set) =>
    typeof set === "number" && set >= 1 && set <= 20
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.backButtonContainer}>
        <BackButton onClick={() => setShowPage('template')} />
      </div>
      ...
      <div className={styles.contentContainer}>
        <div className={styles.container}>
              ...
              <div className={styles.exerciseContainer}>
                ...
                <input
                  ...
                  className={`${styles.sets} ${
                    validationErrors[exercise.id] ? styles.inputError : ""
                  }`}
          ...
          <div className={styles.addRemove}>
            <FaPlusSquare
              onClick={addExercise}
              style={{ color: "#ffffff80", size: "40px" }}
            />
            <FaTrash
          ...
          <div className={styles.buttonContainer}>
            {template.name.length === 0 ? (
              ...
              <button className={styles.saveButton} onClick={savedTemplate}>
                Сохранить тренировку
              </button>
            )}
          </div>
